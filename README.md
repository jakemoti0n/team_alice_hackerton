...
| **권한 요청 화면** | **핵심 가치** |
| :---: | :--- |
| <img width="250" src="https://github.com/user-attachments/assets/d9d0c3fe-9ae8-468d-9222-741941221590" /> | • **신뢰 기반 인터페이스**: 카메라 및 위치 권한 필요성 명시 <br>• **간편한 시작**: 원클릭 권한 허용으로 즉시 서비스 진입 |

---

###  02. 발견 및 촬영 (단 30초!)
현장의 문제를 포착하고 상세 정보를 입력하는 단계입니다. 사진만 찍으면 모든 과정은 AI가 처리합니다. 
...
###  03. AI 분석 및 자동 접수
멀티 에이전트 시스템이 유형 분석부터 부서 매칭까지 자동으로 처리하여 행정 절차를 혁신합니다. 
